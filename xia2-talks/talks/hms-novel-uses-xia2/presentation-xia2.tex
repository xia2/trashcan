...
\begin{itemize}
\item{Run DISTL on every image / 250 from wedge, plot}
\item{Gives near real-time feedback on diffraction}
\item{Very useful tool for showing identification of sample}
\end{itemize}
}
