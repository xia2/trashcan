...
extern int cloud_TppCollisionSearch2(
  float Radius,
  float dt,
  mpsa_Particle *Pcl,
  tpp_Node *Node,
...
extern int cloud_CollideCloudsShock(
  mpsa_Particle *PclA,
  mpsa_Particle *PclB
);
...
extern int cloud_InteractClouds(
  mpsa_Particle *PclA,
  mpsa_Particle *PclB,
  float TransAmount
);
...
extern int cloud_FragmentCloudDisp(
  mpsa_Particle *CloudPcl,
  mpsa_Simulation *Sim,
  mpsa_Pip *CloudPip,
  float vdisp
...
/*[ cloud_MassSpectrumFixed
 *[ action:  calculate mass spectrum information from a list of particles
 *[ objects: takes a tcl interpreter, a list and a flag
 */

extern int cloud_MassSpectrumFixed(
  Tcl_Interp *interp,
  mpsa_List *List,
  int print
);

extern int cloud_DirectCollisionSearch(
  mpsa_List *List,
...
extern int cloud_GridCollisionSearch(
  celllist_List *Grid,
  pairlist_List *List,
  float dt
);
...
extern int cloud_TppCollisionSearchPlus(
  float Radius,
  float dt,
  mpsa_Particle *Pcl,
  tpp_Node *Node,
