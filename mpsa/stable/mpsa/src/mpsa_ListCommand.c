...
)
{
  ...
  if((strcmp(argv[1], "Create") == 0) ||
    ...
    */
  ...
  } else if((strcmp(argv[1], "FourierSpiral") == 0) ||
            (strcmp(argv[1], "fourierspiral") == 0)) {
    ...
    if(argc == 3) {
      mpsa_FourierSpiral(interp, List);
    } else if(argc == 4) {
      if((strcmp(argv[3], "Centre") == 0) ||
	 (strcmp(argv[3], "centre") == 0)) {
	mpsa_FourierSpiralCentre(interp, List);
      } else {
	Tcl_AppendResult(interp, argv[3], " should be centre", (char *) NULL);
	return TCL_ERROR;
      }
    }
